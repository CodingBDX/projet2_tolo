    ...
    this.updateCharacter = function (time) {
        ...
        if (this.delta > this.interval) {
            ...
            for (
                ...
                word.push(
                    this.getRandCharacter(
                        this.currentWord[this.currentCharacter + i]
                    )
                );
            }
            ...
            if (that.useCanvas) {
                ...
                word.forEach(function (w, index) {
                    ...
                    that.holder.appendChild(
                        that.generateSingleCharacter(color, w)
                    );
                });
            }
...
var headline = document.getElementById("search_animated");
